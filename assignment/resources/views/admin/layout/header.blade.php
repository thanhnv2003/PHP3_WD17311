        ...
        <div class="navbar-left">
            <div class="logo-area">
                ...
                <a href="#" class="sidebar-toggle">
                    <img class="svg" src="{{asset('admin/img/svg/align-center-alt.svg')}}" alt="img"></a>
            </div>
                    ...
                    <ul>
                        ...
                        <li class="has-subMenu">
                            ...
                            <ul class="subMenu">
                                ...
                                <li class="layout">
                                    <a href="https://demo.dashboardmarket.com/hexadash-html/rtl">RTL</a>
                                </li>
                                <li class="layout">
                                    <a href="https://demo.dashboardmarket.com/hexadash-html/ltr">LTR</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-subMenu">
                                ...
                                <li>
                                    <ul>
                                        <li class="has-subMenu-left">
                                            <a href="#" class="">
                                                <img src="{{asset('admin/img/svg/mail.svg')}}" alt="mail" class="svg nav-icon">
                                        ...
                                        <li>
                                            <a href="chat.html" class="">
                                                <img src="{{asset('admin/img/svg/message-square.svg')}}" alt="message-square"
                                                     class="svg nav-icon">
                                        ...
                                        <li class="has-subMenu-left">
                                            <a href="#" class="">
                                                <img src="{{asset('admin/img/svg/shopping-cart.svg')}}" alt="shopping-cart"
                                                     class="svg nav-icon">
                                        ...
                                        <li class="has-subMenu-left">
                                            <a href="#" class="">
                                                <img src="{{asset('admin/img/svg/user-check.svg')}}" alt="user-check"
                                                     class="svg nav-icon">
                                        ...
                                        <li>
                                            <a href="chat.html" class="">
                                                <img src="{{asset('admin/img/svg/bookmark.svg')}}" alt="bookmark" class="svg nav-icon">
                                                <span class="menu-text">Note</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="chat.html" class="">
                                                <img src="{{asset('admin/img/svg/activity.svg')}}" alt="activity" class="svg nav-icon">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="kanban.html" class="">
                                                <img src="{{asset('admin/img/svg/columns.svg')}}" alt="columns" class="svg nav-icon">
                                                <span class="menu-text">Kanban Board</span>
                                            </a>
                                        </li>
                                        <li class="has-subMenu-left">
                                            <a href="#" class="">
                                                <img src="{{asset('admin/img/svg/repeat.svg')}}" alt="repeat" class="svg nav-icon">
                                        ...
                                        <li>
                                            <a href="file-manager.html" class="">
                                                <img src="{{asset('admin/img/svg/file.svg')}}" alt="file" class="svg nav-icon">
                                                <span class="menu-text">File Manager</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="task-app.html" class="">
                                                <img src="{{asset('admin/img/svg/clipboard.svg')}}" alt="clipboard"
                                                     class="svg nav-icon">
                                        ...
                                        <li class="has-subMenu-left">
                                            <a href="#" class="">
                                                <img src="{{asset('admin/img/svg/user.svg')}}" alt="user" class="svg nav-icon">
                            ...
                            <ul class="subMenu">
                                <li>
                                    <a href="editors.html" class="">
                                        <img src="{{asset('admin/img/svg/edit.svg')}}" alt="svg" class="svg nav-icon">
                                        <span class="menu-text">Editors</span>
                                    </a>
                                </li>
                                <li class="has-subMenu-left">
                                    <a href="#" class="">
                                        <img src="{{asset('admin/img/svg/grid.svg')}}" alt="grid" class="svg nav-icon">
                                ...
                                <li class="has-subMenu-left">
                                    <a href="#" class="">
                                        <img src="{{asset('admin/img/svg/bar-chart-2.svg')}}" alt="bar-chart-2" class="svg nav-icon">
                                ...
                                <li class="has-subMenu-left">
                                    <a href="#" class="">
                                        <img src="{{asset('admin/img/svg/disc.svg')}}" alt="disc" class="svg nav-icon">
                                ...
                                <li class="has-subMenu-left">
                                    <a href="#" class="">
                                        <img src="{{asset('admin/')}}img/svg/map.svg" alt="map" class="svg nav-icon">
                                ...
                                <li class="has-subMenu-left">
                                    <a href="#" class="">
                                        <img src="{{asset('admin/')}}img/svg/server.svg" alt="server" class="svg nav-icon">
                                ...
                                <li class="has-subMenu-left">
                                    <a href="#" class="">
                                        <img src="{{asset('admin/')}}img/svg/square.svg" alt="square" class="svg nav-icon">
        ...
        <div class="navbar-right">
            <ul class="navbar-right__menu">
                ...
                <li class="nav-message">
                    <div class="dropdown-custom">
                        <a href="javascript:;" class="nav-item-toggle icon-active">
                            <img class="svg" src="{{asset('admin/img/svg/message.svg')}}" alt="img">
                        </a>
                ...
                <li class="nav-notification">
                    <div class="dropdown-custom">
                        <a href="javascript:;" class="nav-item-toggle icon-active">
                            <img class="svg" src="{{asset('admin/img/svg/alarm.svg')}}" alt="img">
                        </a>
                        <div class="dropdown-parent-wrapper">
                            <div class="dropdown-wrapper">
            ...
            <div class="navbar-right__mobileAction d-md-none">
                <a href="#" class="btn-search">
                    <img src="{{asset('admin/img/svg/search.svg')}}" alt="search" class="svg feather-search">
                    <img src="{{asset('admin/img/svg/x.svg')}}" alt="x" class="svg feather-x"></a>
                <a href="#" class="btn-author-action">
                    <img class="svg" src="{{asset('admin/img/svg/more-vertical.svg')}}" alt="more-vertical"></a>
            </div>
        </div>
