                    ...
                    <div class="row shop_wrapper grid_3">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product" data-aos="fade-up" data-aos-delay="200">
                            <div class="product-inner">
                                ...
                                <div class="content">
                                    <h4 class="sub-title"><a href="{{route('product_detail', [$value->id])}}">Studio Design</a></h4>
                                    <h5 class="title"><a href="{{route('product_detail', [$value->id])}}">Basic Jogging Shorts</a></h5>
                                    <span class="ratings">
                                    ...
                                    <span class="old">{{number_format($value->sale_price, 0, ',', '.')}} VNĐ</span>
                                    </span>
